...
describe("A checking account", () => {
    ...
    it("disallows a withdrawal for more than the current available balance (Checking Account Requirement #4)", () => {
        let checking = createCheckingAccount();
        let overdraftAttempt = checking.withdrawMoney(1001, "withdrawal test 1", TransactionOrigin_1.TransactionOrigin.branch);
...
function createCheckingAccount() {
    ...
    let checking = AccountFactory_1.AccountFactory.getCheckingAccountObject(new Date(2000, 0, 1));
